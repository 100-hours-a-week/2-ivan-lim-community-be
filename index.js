...
app.use(cors({
	origin: ['http://127.0.0.1:3000', 'http://localhost:3000','http://43.203.97.60:3000', 'http://43.203.97.60', 'http://ec2-43-203-97-60.ap-northeast-2.compute.amazonaws.com'], // 허용할 클라이언트 도메인
