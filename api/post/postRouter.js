...
postRouter.patch('/:post_id', ssAuthMiddleware, wiBodyChkMiddleware, postImgMiddlewareFactory('newImage'), editPost)
postRouter.delete('/:post_id', ssAuthMiddleware, wiBodyChkMiddleware, deletePost)
